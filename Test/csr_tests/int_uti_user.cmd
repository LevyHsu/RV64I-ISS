# User timer interrupt (cause 4) in user mode
...
# UTI disabled, globally enabled due to being in user mode
...
# non-UTI enabled, globally enabled due to being in user mode
...
# UTI enabled, globally enabled due to being in user mode
...
# UTI enabled, globally enabled and in user mode
