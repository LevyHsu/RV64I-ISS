...
exception_handler_machine_env_call:     
        li      t0, 0x80                # bit mask for MPIE
        beqz    a0, 1f
        csrrs   a0, mstatus, t0         # set if 1
        j       2f
1:      csrrc   a0, mstatus, t0         # clear if 0
2:      andi    a0, a0, 0x80            # mask non-MPIE bits
        srli    a0, a0, 7               # shift to bit 0 to form bool value
        ...
        .globl  set_ie
set_ie:
        ecall           # pass a0 to ecall handler
        ret
