# User external interrupt (cause 8) in user mode
...
# UEI disabled, globally enabled due to being in user mode
...
# non-UEI enabled, globally enabled due to being in user mode
...
# UEI enabled, globally enabled due to being in user mode
...
# UEI enabled, globally enabled and in user mode
